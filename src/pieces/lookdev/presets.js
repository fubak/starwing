...
export const PRESETS = {
  ...
  corneria: {
    ...
    sun: { dir: [0.44, 0.3, -0.85], color: 0xfff4e0, intensity: 2.6, size: 0.03, glow: 0.5 },
    hemi: { sky: 0x7fb6ff, ground: 0x4c6a5a, intensity: 0.7 },
    fill: { dir: [-0.6, 0.25, 0.75], color: 0x9ec8ff, intensity: 0.6 },
    fog: { color: 0x8fc3ff, density: 0.00035 },
    sky: {
      zenith: 0x0a2fa0, horizon: 0x8cc4ff, ground: 0x5f7a98, haze: 3.6,
  ...
  sunset: {
    ...
    sun: { dir: [0.5, 0.09, -0.86], color: 0xffb060, intensity: 2.4, size: 0.045, glow: 1.2 },
    hemi: { sky: 0x7a4ea0, ground: 0x3a1c28, intensity: 0.65 },
    fill: { dir: [-0.7, 0.3, 0.65], color: 0x4a5cff, intensity: 0.9 },
    fog: { color: 0xd8704a, density: 0.0006 },
    sky: {
  ...
  venom: {
    ...
    sun: { dir: [-0.4, 0.2, -0.9], color: 0xe8ff9a, intensity: 2.4, size: 0.04, glow: 1.0 },
    hemi: { sky: 0x6a9a3a, ground: 0x2a1a30, intensity: 0.65 },
    fill: { dir: [0.7, 0.3, 0.7], color: 0xb050ff, intensity: 0.85 },
    fog: { color: 0x5a7a2a, density: 0.0008 },
    sky: {
