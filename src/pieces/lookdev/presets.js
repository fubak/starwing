...
export const PRESETS = {
  ...
  space: {
    ...
    sun: { dir: [0.62, 0.3, -0.72], color: 0xfff1d6, intensity: 3.2, size: 0.035, glow: 1.0 },
    hemi: { sky: 0x3d63b8, ground: 0x2a1a3a, intensity: 0.7 },
    fill: { dir: [-0.7, 0.35, 0.6], color: 0x3f7fff, intensity: 0.9 },
    fog: { color: 0x0a0d24, density: 0 },
    sky: {
      zenith: 0x02040e, horizon: 0x1b2a5a, ground: 0x04030a, haze: 5.5,
  ...
  corneria: {
    ...
    sun: { dir: [0.5, 0.55, -0.67], color: 0xfff4e0, intensity: 3.4, size: 0.03, glow: 0.6 },
    hemi: { sky: 0x7fb6ff, ground: 0x4c6a5a, intensity: 0.7 },
    fill: { dir: [-0.6, 0.25, 0.75], color: 0x9ec8ff, intensity: 0.6 },
    fog: { color: 0xa9d2ff, density: 0.0012 },
    sky: {
      zenith: 0x1a5fd8, horizon: 0xbfe0ff, ground: 0x6f8aa8, haze: 3.2,
  ...
  sunset: {
    ...
    sun: { dir: [0.66, 0.14, -0.74], color: 0xffb060, intensity: 3.0, size: 0.045, glow: 1.4 },
  ...
  venom: {
    ...
    sun: { dir: [-0.6, 0.3, -0.74], color: 0xe8ff9a, intensity: 2.9, size: 0.04, glow: 1.1 },
