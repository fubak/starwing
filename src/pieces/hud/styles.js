...
.sw-boost{left:735px;bottom:52px;width:300px}
...
.sw-bubble{position:relative;margin-left:18px;margin-bottom:6px;width:450px;min-height:100px;padding:12px 18px 14px 22px;
